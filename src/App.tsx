    ...
    <div className="min-h-screen bg-slate-50 font-sans text-slate-900">
      ...
      <section id="home" className="relative flex min-h-screen items-center justify-center overflow-hidden pt-20">
        <div className="absolute inset-0 z-0">
          <div className="absolute top-0 left-0 h-full w-full bg-gradient-to-br from-blue-50/50 to-transparent"></div>
          <div className="absolute -top-24 -right-24 h-96 w-96 rounded-full bg-blue-200/20 blur-3xl"></div>
          <div className="absolute -bottom-24 -left-24 h-96 w-96 rounded-full bg-emerald-200/20 blur-3xl"></div>
        </div>
          ...
          <div className="grid gap-12 md:grid-cols-2 md:items-center">
            ...
            >
              ...
              <div className="mt-12 flex items-center gap-6">
                ...
                <div className="text-sm">
                  <p className="font-bold text-slate-900">500+ Happy Families</p>
                  <p className="text-slate-500">Trusted by parents in Cherthala</p>
                </div>
              </div>
            </motion.div>
            ...
            >
              <div className="relative overflow-hidden rounded-3xl shadow-2xl">
                <img 
                  src="https://static.wixstatic.com/media/3006e6_863765ceda53413487c88c0cdb4e27bc~mv2.jpeg/v1/fill/w_1278,h_832,al_c,q_85,usm_0.66_1.00_0.01,enc_avif,quality_auto/3006e6_863765ceda53413487c88c0cdb4e27bc~mv2.jpeg" 
                  alt="Paithal Clinic Interior"
              ...
              <div className="absolute -bottom-6 -left-6 rounded-2xl bg-white p-6 shadow-xl md:-left-12">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <p className="text-xs font-bold uppercase tracking-wider text-slate-400">Evening Hours</p>
                    <p className="text-sm font-bold text-slate-800">5:00 PM – 7:00 PM</p>
                  </div>
                </div>
              </div>
            </motion.div>
